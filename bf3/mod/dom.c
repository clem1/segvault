...
obj = domobja[i];
     ...
     generation(outp, obj, NULL, 0, 1, mod, 9, 0);
     generation(outp, obj, NULL, 0, 1, mod, 10, 0);
...
if((mode == 2) && (fzo == 1))
{
     ...
     generation(outp, obj, NULL, 0, 1, mod, 1, 0);
     generation(outp, obj, NULL, 0, 1, mod, 2, 0);
     generation(outp, obj, NULL, 0, 1, mod, 3, 0);
     generation(outp, obj, NULL, 0, 1, mod, 4, 0);
...
obj = domobj1[i];
     ...
     generation(outp, obj, NULL, 0, 1, mod, 5, 0);
...
obj = domobj2[i];
     ...
     generation(outp, obj, NULL, 0, 1, mod, 6, 0);
     generation(outp, obj, NULL, 0, 1, mod, 7, 0);
...
obj = domobje[i];
     ...
     generation(outp, obj, NULL, 0, 1, mod, 8, 0);
...
char data[x*2+512], fn[128], *modn = "dom";
...
if(o == 1)
     snprintf(data, sizeof(data), "%s\n%s%s%d.html%s\n%s\n%s.%s(\"%s\");\n%s\n%s", HTMLA, REFRESHA, modn, cnt+1, REFRESHB, JSA, fuzz, DOMDATAB, TESTDATA, JSB, HTMLB);

if(o == 2)
     snprintf(data, sizeof(data), "%s\n%s%s%d.html%s\n%s\n%s.%s(\"%s\");\n%s\n%s", HTMLA, REFRESHA, modn, cnt+1, REFRESHB, JSA, DOMDATAA, fuzz, TESTDATA, JSB, HTMLB);

if(o == 3)
     snprintf(data, sizeof(data), "%s\n%s%s%d.html%s\n%s\n%s.%s = \"%s\";\n%s\n%s", HTMLA, REFRESHA, modn, cnt+1, REFRESHB, JSA, fuzz, DOMDATAD, TESTDATA, JSB, HTMLB);

if(o == 4)
     snprintf(data, sizeof(data), "%s\n%s%s%d.html%s\n%s\n%s.%s = \"%s\";\n%s\n%s", HTMLA, REFRESHA, modn, cnt+1, REFRESHB, JSA, DOMDATAC, fuzz, TESTDATA, JSB, HTMLB);

if(o == 5)
     snprintf(data, sizeof(data), "%s\n%s%s%d.html%s\n%s\n%s(\"%s\");\n%s\n%s", HTMLA, REFRESHA, modn, cnt+1, REFRESHB, JSA, obj, fuzz, JSB, HTMLB);

if(o == 6)
     snprintf(data, sizeof(data), "%s\n%s%s%d.html%s\n%s\n%s(%s);\n%s\n%s", HTMLA, REFRESHA, modn, cnt+1, REFRESHB, JSA, obj, fuzz, JSB, HTMLB);

if(o == 7)
     snprintf(data, sizeof(data), "%s\n%s%s%d.html%s\n%s\n%s(%s, %s);\n%s\n%s", HTMLA, REFRESHA, modn, cnt+1, REFRESHB, JSA, obj, fuzz, fuzz, JSB, HTMLB);
